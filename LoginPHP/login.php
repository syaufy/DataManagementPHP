...
<html lang="en">
  <head>
    ...
    <title>Syanex | Login Sekarang.</title>
  </head>
  <body>
  ...
  <div class="row about">
    ...
    <div class="col-6 text1 text-center mx-auto my-auto" data-aos="fade-left" data-aos-duration="1200">
      ...
      <p>Karena Dengan Login Kamu Bisa Mengakses  Website Ini,,
        <br>Makanya Ayo Login! Dan Kamu Juga Bisa Lihat Akun Lho!
      <br>Dengan Login Kamu Sudah Masuk Komunitas Kami!</p>
    </div>
  </div>

  <div class="daftar text-center" data-aos="fade-up" data-aos-duration="1000">
    <p>Login Sekarang!</p>
  </div>
